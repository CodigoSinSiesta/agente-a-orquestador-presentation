<script lang="ts">
  ...
  const actLabels: Record<(typeof slideNames)[number], string> = {
    hero: '', mapa: '',
    agente: 'Acto I · Fundamentos', 'tool-mcp': 'Acto I · Fundamentos', contexto: 'Acto I · Fundamentos', subagente: 'Acto I · Fundamentos',
    'escalera-base': 'Acto II · Orquestación', 'escalera-top': 'Acto II · Orquestación', 'patron-creator-verifier': 'Acto II · Orquestación', 'patron-hitl-hotl': 'Acto II · Orquestación',
    'harness-ecuacion': 'Acto III · Harness', 'harness-arnes-minimo': 'Acto III · Harness', 'sdd-bucle': 'Acto III · Harness',
    'horizonte-oneshot': 'Acto IV · Horizonte', 'horizonte-oracle': 'Acto IV · Horizonte', 'convergencia-matriz': 'Acto IV · Horizonte', conclusiones: 'Acto IV · Horizonte',
    closing: ''
  };
...
>
  ...
  {#if moduleColors[slideNames[currentSlide]]}
    <div class="module-indicator" style="--mod-color: {moduleColors[slideNames[currentSlide]]}">
      {actLabels[slideNames[currentSlide]]}
    </div>
  {/if}
